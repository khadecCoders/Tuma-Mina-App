...
const TermsAndCons = ({ navigation }) => {
    ...
    return (
      <View>
      <Header title='Ts & Cs' backPress={() => navigation.goBack()} menuPress={() => navigation.toggleDrawer()}/>
  
  
      <Card  mode='contained' elevation={5} style={{backgroundColor: '#fff', paddingBottom: 50, marginVertical: 10, marginHorizontal:5}}>
        <ScrollView>
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Introduction</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>User Aggrement</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Delivery Services</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Payment</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10, fontStyle: 'italic'}}>Refund Processing Timeframes</Text>

        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Same-Day Refund (within 2-4 hours)</Text> 
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Next-Business-Day Refund (within 24 hours)</Text> 
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Standard Refund (within 3-5 business days)</Text> 
        <Text style={{fontSize: 15, fontFamily: 'DMSansRegular', color: COLORS.outline}}>Disputed deliveries or refund requests.</Text>

        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Liability</Text> 
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Governing Laws</Text> 
        <Text style={{fontSize: 15, fontFamily: 'DMSansRegular', color: COLORS.outline}}>a. Zimbabwe laws govern these Terms.</Text>

        <Text>
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Changes</Text>

        We reserve the right to update these Terms.


        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Refund Policy</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Cancellation Policy</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Tuma Mina-Initiated Cancellations</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Privacy Policy</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Data Usage</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Data Sharing</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Data Security</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>User Rights</Text>
        ...
        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Cookie Policy</Text>


        We use cookies to enhance your experience.


        <Text style={{fontSize: 15, fontFamily: 'DMSansSemiBold', color: '#161F3D', marginTop: 10}}>Disclaimer</Text>
